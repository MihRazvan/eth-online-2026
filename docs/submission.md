...
The actual teammate redemption is [0x3ac5…8a3e](https://sepolia.etherscan.io/tx/0x3ac55ef51fee55243983065ab343e41d9b1dd57b72f02a4d0f3340822f028a3e), using 122,011 gas. This verifies that human wallet’s purchase-to-redemption path; the later controlled holder also completed a repeat. Unaided comprehension, two fresh human sessions and a submitted video are not established.
...
- **Lead:** preserve the verified independent payouts/residual accounting and keep the backed judge path executable; renew quotes after changes. Verify the final app/CI and preserve live operations.
