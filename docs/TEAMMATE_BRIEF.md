...
For the team preparing the frontend, rehearsing the product and presenting to ETHOnline 2026 Classic judges. Updated 12 September 2026.
...
The name describes the separation between an asset and the right to enjoy its income. Our visual shorthand is **“Keep the tree. Share the fruit.”** Say “keep the right to recover your position” when explaining custody: the NFT really does leave the LP’s wallet temporarily.
...
| Full local transaction/browser lifecycle; 61 frontend regressions; green implementation CI | Prepare real demo inventory, fresh executable quotes and funded participant wallets |
...
| --- | --- |
| Propose | An LP shares an eligible existing Uniswap v4 position. Sharing or approving it does not start a sale. |
...
- Orchard dots represent shares of **one fixed period**, not separate monthly fruits. The original design-reference text was placeholder copy.
...
| --- | --- |
| [Orchard](https://usufruct-mu.vercel.app/#market) | Issued fee claims, their earning period, available quotes and the difference between a price and uncertain income. Open a claim to inspect terms, buy and follow settlement. Sell-to-bid and maker actions are in My cabinet. |
| [Pin a tree](https://usufruct-mu.vercel.app/#pin) | Find an existing NFT, share its position link, fund an exact offer from another wallet, then approve and accept as the owner. |
| [My cabinet](https://usufruct-mu.vercel.app/#positions) | Claims held, funded offers awaiting acceptance, maker quotes, the right to recover pinned NFTs, transaction receipts and available recovery/redemption actions. |

**Frontend priority:** every step should answer “What do I own now?”, “What can I do next?” and “Why is this action unavailable?” Keep the paper/orchard identity, but use exact financial language beside the metaphor. Keep chain, period, wallet, amount and transaction status visible.
...
| --- | --- | --- |
| 0:00–0:25 | Open Orchard without connecting a wallet | “This is a market for a fixed period of Uniswap USDC fees. The LP gets cash upfront; buyers get the income rights.” |
...
| 1:05–2:10 | Open C; connect the buyer; **Review purchase → Confirm claim purchase**; open **My cabinet** | “This is a separate, already-allocated period, prepared so you can test a payout today. Your claims carry its unpaid income.” Show actual token balances and receipt. |
| 2:10–2:50 | For Example C: **My cabinet → Read claim & recovery → Redeem … claims → Confirm transaction** | “The contract pays the holder directly. The seller’s wallet is not needed.” Show the USDC increase and consumed claim balance. |
