...
| Visual exploration / application | Frontend specialist / lead | local verified | Three rendered concepts;26fixture/safety/receipt/quote tests; actual browser lifecycle now includes exact100USDC expired-offer refund without touching series reserves |
...
| Product research / recovery | Lead / research specialists | research complete; first increments verified | Cited research synthesis; buyer cancellation, authenticated durable retention/API, shared entitlement receipt, bid execution and maker recovery verified locally; recovery UI integration in progress |
