...
| The Graph | No successful live composition retained | Not a substitute for live-provider evidence | Subgraph build; reusable imported Substreams module, WASM/sink and common-block join tests | Studio deployment, authenticated provider stream, hosted joined query, UI result, reproducible module reuse |
